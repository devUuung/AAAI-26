...
src/pke/CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/examples/tckks-interactive-mp-bootstrapping-Chebyshev.cpp.i: cmake_force
	...
	cd /opt/openfhe-gpu/build/src/pke && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/openfhe-gpu/src/pke/examples/tckks-interactive-mp-bootstrapping-Chebyshev.cpp > CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/examples/tckks-interactive-mp-bootstrapping-Chebyshev.cpp.i
...
src/pke/CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/examples/tckks-interactive-mp-bootstrapping-Chebyshev.cpp.s: cmake_force
	...
	cd /opt/openfhe-gpu/build/src/pke && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/openfhe-gpu/src/pke/examples/tckks-interactive-mp-bootstrapping-Chebyshev.cpp -o CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/examples/tckks-interactive-mp-bootstrapping-Chebyshev.cpp.s
...
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: lib/libOPENFHEpke_static.a
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: lib/libOPENFHEcore_static.a
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: lib/libOPENFHEbinfhe_static.a
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: lib/libDeviceFunctions.so
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: lib/libOPENFHEcore_static.a
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: /usr/local/cuda-12.8/targets/x86_64-linux/lib/libcudart.so
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: /usr/lib/x86_64-linux-gnu/librt.a
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: _deps/rmm-build/librmm.so
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: /usr/local/cuda/targets/x86_64-linux/lib/libnvToolsExt.so
bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev: src/pke/CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/opt/openfhe-gpu/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/examples/pke/tckks-interactive-mp-bootstrapping-Chebyshev"
	cd /opt/openfhe-gpu/build/src/pke && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/link.txt --verbose=$(VERBOSE)
...
src/pke/CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/clean:
	cd /opt/openfhe-gpu/build/src/pke && $(CMAKE_COMMAND) -P CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/cmake_clean.cmake
...
src/pke/CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/depend:
	cd /opt/openfhe-gpu/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/openfhe-gpu /opt/openfhe-gpu/src/pke /opt/openfhe-gpu/build /opt/openfhe-gpu/build/src/pke /opt/openfhe-gpu/build/src/pke/CMakeFiles/tckks-interactive-mp-bootstrapping-Chebyshev.dir/DependInfo.cmake "--color=$(COLOR)"
